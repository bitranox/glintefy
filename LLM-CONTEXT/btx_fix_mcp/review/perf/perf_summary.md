...
- **tests/subservers/review/test_deps.py::TestDepsSubServer::test_execute_python_project**: 5.64s
- **tests/subservers/review/test_deps.py::TestDepsSubServer::test_summary_includes_mindset**: 5.39s
- **tests/servers/test_review.py::TestReviewMCPServer::test_run_quality**: 1.39s
